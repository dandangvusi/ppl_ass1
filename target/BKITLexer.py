...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7u\2\2\u014c\u014d\7g\2\2\u014d\u014e\7n\2\2\u014e\u014f")
...
class BKITLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            ...
            "STRLIT", "ARRAY_LIT", "BODY", "BREAK", "CONTINUE", "DO", "ELSE", 
            "ELSELF", "ENDBODY", "ENDIF", "ENDFOR", "ENDWHILE", "FOR", "FUNCTION", 
    ...
    ruleNames = [ "DEGIT", "DEGIT_NO_ZERO", "OCT_DEGIT", "OCT_DEGIT_NO_ZERO", 
                  ...
                  "BOOL_LIT", "STRLIT", "ARRAY_LIT", "BODY", "BREAK", "CONTINUE", 
                  "DO", "ELSE", "ELSELF", "ENDBODY", "ENDIF", "ENDFOR", 
